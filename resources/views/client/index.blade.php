    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                <div class="full"> <img class="img-responsive" src="templateportfolio/images/resume_img4.png" alt="#" />
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 black_fonts_title">
                ...
                <h4 class="small_heading_title_3" >A recruiter-tested CV maker tool</h4>
...
<div class="section layout_padding theme_bg_titl">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                <div class="full"> <img class="img-responsive" src="templateportfolio/images/resume_img3.png" alt="#" />
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 black_fonts">
                <h3 class="small_heading_titl">Try our professional Resume builder now!</h3>
                <p>Save time with our easy 3-step resume builder. No more writer’s block or formatting difficulties in Word.</p>
                ...
                <p>Create a professional story in minutes. Use our cover letter maker.
...
<div class="section layout_padding">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="full center">
                    <a href="{{ url('about') }}" class="hvr-radial-out button-theme">See More ></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 title_fonts_default">
                ...
                <p>A great job application leads to a good interview. An amazing resume is what makes it all possible. Start off strong with the hiring manager by creating a positive professional image. A job interview can be much easier if they have a favorable view of your CV and cover letter.
                </p>
                <p>Creating a resume or cover letter has never been this easy! In three simple steps, create the perfect document to impress hiring managers and employers. Minimum time, maximum professional quality.
                </p>
                <p>Creating a resume or cover letter has never been this easy! In three simple steps, create the perfect document to impress hiring managers and employers. Minimum time, maximum professional quality.
                </p>
